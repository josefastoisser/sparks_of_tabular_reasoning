...
def parse_args():
    ...
    parser.add_argument('--reward_func', type=str, nargs='+', default=['llm_exe_reward' , 'llm_scoring_classes_judge_reward' ,'string_matching_reward'])
    ...
    parser.add_argument('--reward_weights', type=float, nargs='+', default=[0.3, 0.4 , 0.3])
